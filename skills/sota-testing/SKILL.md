...
1. Before writing tests, read the rules files relevant to the layer you are
   ...
   `01`, `02`, `03`, `04`.
2. Apply the relevant **top-10 non-negotiables** (below); do not add unrelated
   test infrastructure outside the requested change.
3. Decide the suite shape FIRST (`rules/01`): what counts as a unit here, where
   ...
   decision down for new or materially restructured suites. A focused test
   change does not require new strategy documentation.
